Module PrebaciNamirnicuModul
    Sub PrebaciNamirnicu()
        On Error Resume Next
        With Form1
            ' Gubici vitamina
            Dim Gubici_LB As ListBox = .ListBox83
            Dim Karoten As Double = Gubici_LB.Items(0) / 100
            Dim VitaminD As Double = Gubici_LB.Items(1) / 100
            Dim VitaminE As Double = Gubici_LB.Items(2) / 100
            Dim VitaminB1 As Double = Gubici_LB.Items(3) / 100
            Dim VitaminB2 As Double = Gubici_LB.Items(4) / 100
            Dim VitaminB3 As Double = Gubici_LB.Items(5) / 100
            Dim VitaminB6 As Double = Gubici_LB.Items(6) / 100
            Dim VitaminB12 As Double = Gubici_LB.Items(7) / 100
            Dim Folat As Double = Gubici_LB.Items(8) / 100
            Dim PantotenskaKiselina As Double = Gubici_LB.Items(9) / 100
            Dim Biotin As Double = Gubici_LB.Items(10) / 100
            Dim VitaminC As Double = Gubici_LB.Items(11) / 100
            Dim VitaminK As Double = Gubici_LB.Items(12) / 100
            ...
            .Label319.DataBindings.Clear()  'cijena
            .Label329.DataBindings.Clear()  'Termicka obrada
            ...
            .Label27.Text = .DataGridView2.Rows(i).Cells(1).Value

            .Label329.DataBindings.Add(New Binding("Text", BS, "TermickaObrada"))
            .Label329.Text = .ComboBox11.Text
            If .ComboBox11.Text = "Termička obrada" Or .ComboBox11.Text = "" Then .Label329.Text = "N"

            .Label106.DataBindings.Add(New Binding("Text", BS, "Serviranja"))
            .Label106.Text = .TextBox85.Text

            .Label31.DataBindings.Add(New Binding("Text", BS, "Kolicina"))
            If .DataGridView2.Rows(i).Cells(2).Value.ToString = "N" Then
                .Label31.Text = "N"
            Else
                .Label31.Text = .TextBox12.Text
            End If
            ...
            Else
                ...
                .Label65.Text = .Label65.Text - .Label65.Text * Karoten   'gubitak vitamina
            End If
            ...
            Else
                ...
                .Label66.Text = .Label66.Text - .Label66.Text * VitaminD
            End If
            ...
            Else
                ...
                .Label67.Text = .Label67.Text - .Label67.Text * VitaminE
            End If
            ...
            Else
                ...
                .Label68.Text = .Label68.Text - .Label68.Text * VitaminB1
            End If
            ...
            Else
                ...
                .Label69.Text = .Label69.Text - .Label69.Text * VitaminB2
            End If
            ...
            Else
                ...
                .Label70.Text = .Label70.Text - .Label70.Text * VitaminB3
            End If
            ...
            Else
                ...
                .Label71.Text = .Label71.Text - .Label71.Text * VitaminB6
            End If
            ...
            Else
                ...
                .Label72.Text = .Label72.Text - .Label72.Text * VitaminB12
            End If
            ...
            Else
                ...
                .Label73.Text = .Label73.Text - .Label73.Text * Folat
            End If
            ...
            Else
                ...
                .Label74.Text = .Label74.Text - .Label74.Text * PantotenskaKiselina
            End If
            ...
            Else
                ...
                .Label75.Text = .Label75.Text - .Label75.Text * Biotin
            End If
            ...
            Else
                ...
                .Label76.Text = .Label76.Text - .Label76.Text * VitaminC
            End If
            ...
            Else
                ...
                .Label77.Text = .Label77.Text - .Label77.Text * VitaminK
            End If
            ...
            'cijena
            .Label319.DataBindings.Add(New Binding("Text", BS, "Cijena"))
            If Val(.TextBox77.Text) > 0.01 Then
                '  .Label319.Text = (.TextBox77.Text / 1000) * .Label33.Text 'cijena namirnice   (label33-masa)
                .Label319.Text = Format(((.Label331.Text) / 1000) * .Label33.Text, "0.00")
            Else
                'pogledaj cijenu u cijene DGV
                Dim a As Integer
                Dim DGV_Cijene As DataGridView = .DataGridView15
                ' FavoritiSpremiForm.Show()
                ' .TabControl1.SelectedIndex = 9
                For a = 0 To DGV_Cijene.RowCount - 1
                    If DGV_Cijene.Rows(a).Cells(1).Value IsNot DBNull.Value Then
                        If DGV_Cijene.Rows(a).Cells(1).Value = .Label27.Text Then
                            .Label319.Text = (DGV_Cijene.Rows(a).Cells(2).Value / 1000) * .Label33.Text   'cijena namirnice
                        End If
                    End If
                Next
