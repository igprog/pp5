Module PrepBrojServDijabetModul
    Sub PrepBrojServDijabet()
        'Dijabeticke dijete
        On Error Resume Next
        With Form1
            Dim TEE As Integer = .TextBox3.Text
            Dim K As Integer = 1  'broj korisnika
            '  TEE = .Label81.Text
            ...
            If TEE > 0 And TEE <= 1900 Then
                .ListBox2.Items.Insert(0, 10 * K)   'Žitarice"
            ...
            If TEE > 2900 And TEE <= 3100 Then
                ...
                .ListBox2.Items.Insert(3, 10 * K)   'Meso
            ...
            If TEE > 3300 And TEE <= 3500 Then
                ...
                .ListBox2.Items.Insert(2, 8 * K)   'Voće
                .ListBox2.Items.Insert(3, 10 * K)   'Meso
                .ListBox2.Items.Insert(4, 5 * K) 'Mlijeko
                .ListBox2.Items.Insert(5, 15 * K)   'Masti
            End If

            If TEE > 3500 And TEE <= 3700 Then
                .ListBox2.Items.Insert(0, 19 * K)   'Žitarice"
                .ListBox2.Items.Insert(1, 10 * K)  'Povrće
                .ListBox2.Items.Insert(2, 9 * K)   'Voće
                .ListBox2.Items.Insert(3, 11 * K)   'Meso
                .ListBox2.Items.Insert(4, 5 * K) 'Mlijeko
                .ListBox2.Items.Insert(5, 16 * K)   'Masti
            End If

            If TEE > 3700 And TEE <= 3900 Then
                .ListBox2.Items.Insert(0, 20 * K)   'Žitarice"
                .ListBox2.Items.Insert(1, 11 * K)  'Povrće
                .ListBox2.Items.Insert(2, 10 * K)   'Voće
                .ListBox2.Items.Insert(3, 12 * K)   'Meso
                .ListBox2.Items.Insert(4, 5 * K) 'Mlijeko
                .ListBox2.Items.Insert(5, 16 * K)   'Masti
            End If
            ...
            If TEE > 3900 Then
                ...
                .ListBox2.Items.Insert(1, 12 * K)  'Povrće
                .ListBox2.Items.Insert(2, 10 * K)   'Voće
                .ListBox2.Items.Insert(3, 12 * K)   'Meso
                .ListBox2.Items.Insert(4, 5 * K) 'Mlijeko
                .ListBox2.Items.Insert(5, 17 * K)   'Masti
            End If
